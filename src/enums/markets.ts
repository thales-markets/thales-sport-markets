...
export enum ParlayErrorCode {
    ...
    SAME_PLAYER_SAME_GAME_PLAYER_PROPS = 9,
}
...
export const ONE_SIDER_PLAYER_PROPS_BET_TYPES = [BetType.PLAYER_PROPS_TOUCHDOWNS, BetType.PLAYER_PROPS_GOALS];
