...
export enum BetType {
    ...
    HALFTIME_SPREAD = 10011,
    HALFTIME_TOTAL = 10012,
    SPREAD2 = 10013,
    TOTAL2 = 10014,
...
export const TOTAL_BET_TYPES = [BetType.TOTAL, BetType.TOTAL2, BetType.HALFTIME_TOTAL];

export const SPREAD_BET_TYPES = [BetType.SPREAD, BetType.SPREAD2, BetType.HALFTIME_SPREAD];
...
export const MARKET_TYPES_WITH_DRAW = [BetType.WINNER, BetType.HALFTIME];
