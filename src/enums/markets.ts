...
export const TOTAL_BET_TYPES = [BetType.TOTAL, BetType.TOTAL2, BetType.TOTAL_HOME_TEAM, BetType.TOTAL_AWAY_TEAM];
...
export const DOUBLE_CHANCE_BET_TYPES = [
    BetType.DOUBLE_CHANCE,
    BetType.FIRST_PERIOD_DOUBLE_CHANCE,
    BetType.SECOND_PERIOD_DOUBLE_CHANCE,
];
