...
import useLpPpStatsByTypeQuery from 'queries/pnl/useLpPpStatsByTypeQuery';
    ...
    return (
        <Wrapper>
            <SectionWrapper>
                ...
                {Object.keys(lpStats)
                    .sort((keyA: string, keyB: string) => (keyA < keyB ? 1 : -1))
                    .map((key, index) => {
                        const stats = lpStats[key][lpStats[key].length - 1];
                        const statsName = key;
                        return (
