...
export const LiveGamesContainer = styled(Row)`
    @media (max-width: 767px) {
        flex-direction: column-reverse;
    }
`;

export const StyledLiveGameImage = styled(LiveGameImage)`
    @media (max-width: 767px) {
        margin-top: 10px;
    }
`;
...
export const HouseContainer = styled(Row)`
    @media (max-width: 767px) {
        flex-direction: column-reverse;
    }
`;
...
export const LaptopContainer = styled(FlexDivColumn)`
    position: relative;
