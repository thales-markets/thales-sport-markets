...
const LiquidityPoolSingle: React.FC = () => {
    ...
    return (
        <Wrapper>
                ...
                {!liquidityPoolData ? (
                    ...
                    <>
                        <MainContentContainer>
                            ...
                            <Return liquidityPoolType={'single'} />
                        </MainContentContainer>
                        <MainContentContainer>
                            {liquidityPoolData && (
                                <PnL
            ...
            {liquidityPoolData && <Transactions currentRound={liquidityPoolData.round} liquidityPoolType={'single'} />}
            {openApprovalModal && (
                <ApprovalModal
...
export default LiquidityPoolSingle;
