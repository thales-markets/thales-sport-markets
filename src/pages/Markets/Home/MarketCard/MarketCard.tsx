...
import /*Info, InfoContent, InfoLabel*/ 'components/common';
import {
    MatchDate,
    MatchInfo,
    MatchInfoColumn,
...
const marketDummyData = {
    ...
    positions: ['barcelona', 'draw', 'real madrid'],
    participants: ['barcelona, real'],
    odds: [0.7, 0.1, 0.2],
};
    ...
    return (
        <Container isClaimAvailable={claimAvailable}>
            {/* <MatchParticipants/>
                ...
                <Tags/>
            */}
            <MatchDate>{marketDummyData.date}</MatchDate>
            <MatchInfo>
                {/* <MatchParticipant
                className={
                ...
                {/* <MatchParticipantName>{marketDummyData.participants[1]}</MatchParticipantName> */}
                {/* </MatchParticipant> */}
            </MatchInfo>
            {/* <Info></Info> */}
