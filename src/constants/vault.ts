...
export const VAULT_MAP: Record<string, any> = {
    'discount-vault': {
        addresses: {
            ...
            [Network.ArbitrumOne]: '0xfF7AEA98740fA1e2a9eB81680583e62aaFf1e3Ad',
        },
    },
    'degen-discount-vault': {
        addresses: {
            ...
            [Network.ArbitrumOne]: '0xA852a651377fbE23f3d3acF5919c3D092aD4b77d',
        },
    },
    'safu-discount-vault': {
        addresses: {
            ...
            [Network.OptimismGoerli]: '',
            [Network.ArbitrumOne]: '0xE26374c7aFe71a2a6AB4A61080772547C43B87E6',
        },
    },
    'upsettoor-vault': {
        addresses: {
            ...
            [Network.OptimismGoerli]: '',
            [Network.ArbitrumOne]: '0x31c2947c86412A5e33794105aA034DD9312eb711',
        },
    },
    'parlay-discount-vault': {
        addresses: {
            ...
            [Network.ArbitrumOne]: '0xAb9E5fc491c743AE0b45f7100fAf611Deb8FeC4A',
        },
    },
};
