export const theRundownConsumerContract = {
    ...
    abi: [
        ...
        { inputs: [], name: 'removeFromCreatedQueue', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        { inputs: [], name: 'removeFromResolvedQueue', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        {
        ...
        {
            inputs: [{ internalType: 'contract GamesQueue', name: '_queues', type: 'address' }],
        ...
        {
            inputs: [{ internalType: 'address', name: '_sportsManager', type: 'address' }],
