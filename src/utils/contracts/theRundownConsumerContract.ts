export const theRundownConsumerContract = {
    ...
    abi: [
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'address', name: '_wrapperAddress', type: 'address' },
                { indexed: false, internalType: 'contract GamesQueue', name: '_queues', type: 'address' },
                { indexed: false, internalType: 'address', name: '_sportsManager', type: 'address' },
                { indexed: false, internalType: 'address', name: '_verifier', type: 'address' },
            ],
        ...
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'address', name: '_sportsManager', type: 'address' }],
            name: 'NewSportsMarketManager',
            type: 'event',
        },
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'address', name: '_wrapperAddress', type: 'address' }],
        ...
        },
        {
            ...
            inputs: [
                { indexed: false, internalType: 'address', name: '_marketAddress', type: 'address' },
                { indexed: false, internalType: 'bytes32', name: '_id', type: 'bytes32' },
                { indexed: false, internalType: 'uint256', name: '_outcome', type: 'uint256' },
            ],
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'uint256', name: '_status', type: 'uint256' },
                { indexed: false, internalType: 'bool', name: '_isSupported', type: 'bool' },
            ],
        ...
        },
        {
            ...
            inputs: [
                { indexed: false, internalType: 'uint256', name: '_sportId', type: 'uint256' },
                { indexed: false, internalType: 'bool', name: '_isTwoPosition', type: 'bool' },
            ],
        ...
        },
        {
            inputs: [
                ...
                { internalType: 'bool', name: '_useBackupOdds', type: 'bool' },
            ],
        ...
        },
        {
            ...
            outputs: [
                { internalType: 'uint256', name: '_sportId', type: 'uint256' },
                { internalType: 'uint256', name: '_gameDate', type: 'uint256' },
        ...
        },
        {
            inputs: [
                ...
                { internalType: 'uint256[]', name: '_supportedSportIds', type: 'uint256[]' },
                { internalType: 'address', name: '_sportsManager', type: 'address' },
                { internalType: 'uint256[]', name: '_twoPositionSports', type: 'uint256[]' },
                { internalType: 'contract GamesQueue', name: '_queues', type: 'address' },
                { internalType: 'uint256[]', name: '_resolvedStatuses', type: 'uint256[]' },
                { internalType: 'uint256[]', name: '_cancelGameStatuses', type: 'uint256[]' },
            ],
            name: 'initialize',
            outputs: [],
            stateMutability: 'nonpayable',
        ...
        {
            inputs: [{ internalType: 'uint256', name: '_sportsId', type: 'uint256' }],
        ...
        {
            inputs: [{ internalType: 'string', name: '_market', type: 'string' }],
        ...
        {
            inputs: [{ internalType: 'uint256', name: '_sportId', type: 'uint256' }],
        ...
        },
        {
            inputs: [],
            name: 'queues',
            outputs: [{ internalType: 'contract GamesQueue', name: '', type: 'address' }],
            stateMutability: 'view',
            type: 'function',
        },
        {
        ...
        },
        {
            inputs: [],
            name: 'verifier',
            outputs: [{ internalType: 'contract ITherundownConsumerVerifier', name: '', type: 'address' }],
            stateMutability: 'view',
            type: 'function',
        },
        {
...
export default theRundownConsumerContract;
