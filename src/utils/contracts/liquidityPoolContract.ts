export const liquidityPoolContract = {
    ...
    abi: [
        ...
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'uint256', name: '_stakedThalesMultiplier', type: 'uint256' }],
        ...
        {
            inputs: [{ internalType: 'uint256', name: '_stakedThalesMultiplier', type: 'uint256' }],
