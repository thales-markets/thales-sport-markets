    ...
    abi: [
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'address', name: '_exoticMarketMastercopy', type: 'address' },
                { indexed: false, internalType: 'address', name: '_exoticMarketOpenBidMastercopy', type: 'address' },
                { indexed: false, internalType: 'address', name: '_oracleCouncilAddress', type: 'address' },
                { indexed: false, internalType: 'address', name: '_paymentToken', type: 'address' },
                { indexed: false, internalType: 'address', name: '_tagsAddress', type: 'address' },
                { indexed: false, internalType: 'address', name: '_theRundownConsumerAddress', type: 'address' },
                { indexed: false, internalType: 'address', name: '_marketDataAddress', type: 'address' },
                { indexed: false, internalType: 'address', name: '_exoticRewards', type: 'address' },
                { indexed: false, internalType: 'address', name: '_safeBoxAddress', type: 'address' },
            ],
        ...
        },
        {
            ...
            inputs: [
                ...
                { indexed: false, internalType: 'uint256', name: 'arbitraryRewardForDisputor', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'maxAmountForOpenBidPosition', type: 'uint256' },
            ],
            name: 'AmountsUpdated',
            type: 'event',
        },
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'uint256', name: 'backstopTimeout', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'minimumPositioningDuration', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'withdrawalTimePeriod', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'pDAOResolveTimePeriod', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'claimTimeoutDefaultPeriod', type: 'uint256' },
            ],
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'bool', name: '_creationRestrictedToOwner', type: 'bool' },
                { indexed: false, internalType: 'bool', name: '_openBidAllowed', type: 'bool' },
            ],
            name: 'FlagsUpdated',
            type: 'event',
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'uint256', name: 'marketQuestionStringLimit', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'marketSourceStringLimit', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'marketPositionStringLimit', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'disputeStringLengthLimit', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'maximumPositionsAllowed', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'maxNumberOfTags', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'maxOracleCouncilMembers', type: 'uint256' },
            ],
            name: 'LimitsUpdated',
            type: 'event',
        },
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'uint256', name: 'safeBoxPercentage', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'creatorPercentage', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'resolverPercentage', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'withdrawalPercentage', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'maxFinalWithdrawPercentage', type: 'uint256' },
            ],
        ...
        {
            inputs: [
                { internalType: 'address', name: '_exoticMarketMastercopy', type: 'address' },
                { internalType: 'address', name: '_exoticMarketOpenBidMastercopy', type: 'address' },
                { internalType: 'address', name: '_oracleCouncilAddress', type: 'address' },
                { internalType: 'address', name: '_paymentToken', type: 'address' },
                { internalType: 'address', name: '_tagsAddress', type: 'address' },
                { internalType: 'address', name: '_theRundownConsumerAddress', type: 'address' },
                { internalType: 'address', name: '_marketDataAddress', type: 'address' },
                { internalType: 'address', name: '_exoticRewards', type: 'address' },
                { internalType: 'address', name: '_safeBoxAddress', type: 'address' },
            ],
            name: 'setAddresses',
            outputs: [],
            stateMutability: 'nonpayable',
        ...
        },
        {
            inputs: [
                ...
                { internalType: 'uint256', name: '_arbitraryRewardForDisputor', type: 'uint256' },
                { internalType: 'uint256', name: '_maxAmountForOpenBidPosition', type: 'uint256' },
            ],
            name: 'setAmounts',
            outputs: [],
            stateMutability: 'nonpayable',
        ...
        {
            inputs: [
                { internalType: 'uint256', name: '_backstopTimeout', type: 'uint256' },
                { internalType: 'uint256', name: '_minimumPositioningDuration', type: 'uint256' },
                { internalType: 'uint256', name: '_withdrawalTimePeriod', type: 'uint256' },
                { internalType: 'uint256', name: '_pDAOResolveTimePeriod', type: 'uint256' },
                { internalType: 'uint256', name: '_claimTimeoutDefaultPeriod', type: 'uint256' },
            ],
            name: 'setDurations',
            outputs: [],
            stateMutability: 'nonpayable',
        ...
        {
            inputs: [
                { internalType: 'bool', name: '_creationRestrictedToOwner', type: 'bool' },
                { internalType: 'bool', name: '_openBidAllowed', type: 'bool' },
            ],
            name: 'setFlags',
            outputs: [],
            stateMutability: 'nonpayable',
        ...
        {
            inputs: [
                { internalType: 'uint256', name: '_marketQuestionStringLimit', type: 'uint256' },
                { internalType: 'uint256', name: '_marketSourceStringLimit', type: 'uint256' },
                { internalType: 'uint256', name: '_marketPositionStringLimit', type: 'uint256' },
                { internalType: 'uint256', name: '_disputeStringLengthLimit', type: 'uint256' },
                { internalType: 'uint256', name: '_maximumPositionsAllowed', type: 'uint256' },
                { internalType: 'uint256', name: '_maxNumberOfTags', type: 'uint256' },
                { internalType: 'uint256', name: '_maxOracleCouncilMembers', type: 'uint256' },
            ],
            name: 'setLimits',
            outputs: [],
            stateMutability: 'nonpayable',
        ...
        {
            inputs: [
                { internalType: 'uint256', name: '_safeBoxPercentage', type: 'uint256' },
                { internalType: 'uint256', name: '_creatorPercentage', type: 'uint256' },
                { internalType: 'uint256', name: '_resolverPercentage', type: 'uint256' },
                { internalType: 'uint256', name: '_withdrawalPercentage', type: 'uint256' },
                { internalType: 'uint256', name: '_maxFinalWithdrawPercentage', type: 'uint256' },
            ],
            name: 'setPercentages',
            outputs: [],
            stateMutability: 'nonpayable',
