export const thalesBondsContract = {
    ...
    abi: [
        ...
        },
        {
            ...
            inputs: [
                { indexed: false, internalType: 'address', name: 'market', type: 'address' },
                { indexed: false, internalType: 'address', name: 'disputor', type: 'address' },
                { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
            ],
        ...
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'address', name: 'managerAddress', type: 'address' }],
            name: 'NewManagerAddress',
            type: 'event',
        },
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'address', name: 'oracleCouncil', type: 'address' }],
        ...
        },
        {
            ...
            name: 'marketBond',
            outputs: [
                { internalType: 'uint256', name: 'totalDepositedMarketBond', type: 'uint256' },
                { internalType: 'uint256', name: 'totalMarketBond', type: 'uint256' },
                { internalType: 'uint256', name: 'creatorBond', type: 'uint256' },
                { internalType: 'uint256', name: 'resolverBond', type: 'uint256' },
