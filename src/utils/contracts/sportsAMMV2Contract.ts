...
const sportsAMMV2Contract: ContractData = {
    addresses: {
        ...
        [Network.Base]: '0x76923cDDE21928ddbeC4B8BFDC8143BB6d0841a8',
    ...
    abi: [
        ...
        { inputs: [], name: 'IllegalInputAmounts', type: 'error' },
        { inputs: [], name: 'InsuffETHSent', type: 'error' },
        { inputs: [], name: 'InsuffReceived', type: 'error' },
        { inputs: [], name: 'InvalidInitialization', type: 'error' },
        { inputs: [], name: 'InvalidLength', type: 'error' },
        { inputs: [], name: 'InvalidPosition', type: 'error' },
        { inputs: [], name: 'InvalidSender', type: 'error' },
        { inputs: [], name: 'MultiCollatDisabled', type: 'error' },
        { inputs: [], name: 'MultiCollateralDisabled', type: 'error' },
        { inputs: [], name: 'NotInitializing', type: 'error' },
        { inputs: [], name: 'OfframpOnlyDefaultCollateralAllowed', type: 'error' },
        { inputs: [], name: 'OnlyDedicatedProcessor', type: 'error' },
        { inputs: [], name: 'OnlyOwner', type: 'error' },
        { inputs: [], name: 'OnlyTicketOwner', type: 'error' },
        { inputs: [], name: 'SBDOutOfRange', type: 'error' },
        {
            inputs: [{ internalType: 'address', name: 'token', type: 'address' }],
            name: 'SafeERC20FailedOperation',
            type: 'error',
        },
        { inputs: [], name: 'UndefinedRecipient', type: 'error' },
        { inputs: [], name: 'UnknownTicket', type: 'error' },
        { inputs: [], name: 'UnsupportedSender', type: 'error' },
        { inputs: [], name: 'ZeroAmount', type: 'error' },
        { inputs: [], name: 'ZeroPriceForCollateral', type: 'error' },
        {
            anonymous: false,
            inputs: [
        ...
        },
        {
            ...
            inputs: [
                ...
                { indexed: false, internalType: 'uint256', name: 'addedPayout', type: 'uint256' },
                { indexed: false, internalType: 'address', name: 'safeBox', type: 'address' },
            ],
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'address', name: 'liveTradingProcessor', type: 'address' },
                { indexed: false, internalType: 'address', name: 'sgpTradingProcessor', type: 'address' },
                { indexed: false, internalType: 'address', name: 'freeBetsHolder', type: 'address' },
            ],
            name: 'SetBettingProcessors',
            type: 'event',
        },
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'address', name: 'onOffRamper', type: 'address' }],
        ...
        },
        {
            inputs: [
                { internalType: 'address', name: '_ticket', type: 'address' },
                { internalType: 'enum ISportsAMMV2.TicketAction', name: 'action', type: 'uint8' },
            ],
            name: 'handleTicketResolving',
            outputs: [],
            stateMutability: 'nonpayable',
            type: 'function',
        },
        ...
        },
        {
            inputs: [
                ...
                { internalType: 'address', name: '_sgpTradingProcessor', type: 'address' },
        ...
        {
            inputs: [{ internalType: 'address', name: '_onOffRamper', type: 'address' }],
            name: 'setMultiCollateralOnOffRamp',
            outputs: [],
            stateMutability: 'nonpayable',
            type: 'function',
        ...
        },
        {
            ...
            name: 'withdrawCollateralFromTicket',
            outputs: [],
            stateMutability: 'nonpayable',
            type: 'function',
        },
