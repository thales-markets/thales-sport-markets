export const sportsVaultContract = {
    ...
    abi: [
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'uint256', name: 'allocationLimitsPerMarketPerRound', type: 'uint256' },
            ],
        ...
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'uint256', name: 'SetMinTradeAmount', type: 'uint256' }],
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'uint256', name: 'priceLowerLimit', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: 'priceUpperLimit', type: 'uint256' },
            ],
            name: 'SetPriceLimits',
            type: 'event',
        },
        ...
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'int256', name: 'skewImpact', type: 'int256' }],
            name: 'SetSkewImpactLimit',
            type: 'event',
        },
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'address', name: 'thalesAmm', type: 'address' }],
            ...
            inputs: [
                {
                    components: [
                        ...
                        { internalType: 'uint256', name: '_priceLowerLimit', type: 'uint256' },
                        { internalType: 'uint256', name: '_priceUpperLimit', type: 'uint256' },
                        { internalType: 'int256', name: '_skewImpactLimit', type: 'int256' },
                        { internalType: 'uint256', name: '_allocationLimitsPerMarketPerRound', type: 'uint256' },
                        ...
                        { internalType: 'uint256', name: '_minTradeAmount', type: 'uint256' },
                    ],
        ...
        {
            inputs: [{ internalType: 'uint256', name: '_allocationLimitsPerMarketPerRound', type: 'uint256' }],
            name: 'setAllocationLimits',
            outputs: [],
            stateMutability: 'nonpayable',
            type: 'function',
        ...
        {
            inputs: [{ internalType: 'uint256', name: '_minTradeAmount', type: 'uint256' }],
            name: 'setMinTradeAmount',
            outputs: [],
            stateMutability: 'nonpayable',
            type: 'function',
        ...
        {
            inputs: [{ internalType: 'int256', name: '_skewImpactLimit', type: 'int256' }],
            name: 'setSkewImpactLimit',
            outputs: [],
            stateMutability: 'nonpayable',
            type: 'function',
        ...
        {
            inputs: [{ internalType: 'contract ISportsAMM', name: '_sportAMM', type: 'address' }],
            name: 'setSportAmm',
            outputs: [],
            stateMutability: 'nonpayable',
            type: 'function',
        ...
        { inputs: [], name: 'startVault', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        {
            inputs: [
        ...
        },
        {
            ...
            outputs: [{ internalType: 'enum ISportsAMM.Position', name: '', type: 'uint8' }],
            stateMutability: 'view',
            type: 'function',
        },
        {
