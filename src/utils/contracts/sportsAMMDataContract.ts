...
const sportsAMMDataContract: ContractData = {
    addresses: {
        ...
        [Network.Base]: '0x99D318b6402cE95B6B46F40f752eA96430A2Ead0',
    ...
    abi: [
            ...
            outputs: [
                {
                    components: [
                        ...
                        { internalType: 'bool', name: 'isSGP', type: 'bool' },
                    ],
        ...
        },
        {
            ...
            name: 'getCapsPerMarkets',
            outputs: [{ internalType: 'uint256[]', name: 'caps', type: 'uint256[]' }],
            stateMutability: 'view',
            type: 'function',
        },
        {
        ...
        },
        {
            inputs: [
                ...
                { internalType: 'uint256[]', name: '_playerIds', type: 'uint256[]' },
                { internalType: 'uint256[]', name: '_positions', type: 'uint256[]' },
            ],
            name: 'getRiskOnMarkets',
            outputs: [{ internalType: 'int256[]', name: 'riskAmounts', type: 'int256[]' }],
            stateMutability: 'view',
            type: 'function',
        },
        {
