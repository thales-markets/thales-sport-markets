...
const stakingThalesContract: ContractData = {
    addresses: {
    ...
    abi: [
        ...
        },
        {
            ...
            inputs: [
                ...
                { indexed: false, internalType: 'address', name: 'stakingThalesBonusRewardsManager', type: 'address' },
            ],
        ...
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'uint256', name: 'lastPeriodTimestamp', type: 'uint256' }],
            name: 'LastPeriodTimestampSet',
            type: 'event',
        },
        {
            anonymous: false,
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'uint256', name: '_currentPeriodRewards', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: '_extraRewards', type: 'uint256' },
                { indexed: false, internalType: 'uint256', name: '_revShare', type: 'uint256' },
            ],
            name: 'ReceivedStakingRewardsUpdate',
            type: 'event',
        },
        {
            anonymous: false,
        ...
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'address', name: 'stakingThalesBettingProxy', type: 'address' }],
        ...
        },
        {
            ...
            inputs: [
                ...
                { indexed: false, internalType: 'bool', name: 'readOnlyMode', type: 'bool' },
                { indexed: false, internalType: 'bool', name: 'sendCCIPMessage', type: 'bool' },
            ],
        ...
        },
        {
            ...
            name: 'decreaseStakingBalanceFor',
            outputs: [],
            payable: false,
            stateMutability: 'nonpayable',
            type: 'function',
        ...
        },
        {
            ...
            inputs: [{ internalType: 'address', name: 'account', type: 'address' }],
            name: 'getTotalBonus',
            outputs: [{ internalType: 'uint256', name: 'returnValue', type: 'uint256' }],
            payable: false,
            stateMutability: 'view',
            type: 'function',
        },
        ...
        },
        {
            ...
            name: 'increaseStakingBalanceFor',
            outputs: [],
            payable: false,
            stateMutability: 'nonpayable',
            type: 'function',
        ...
        },
        {
            constant: false,
            inputs: [],
            name: 'sendRoundClosingMessageCrosschain',
            outputs: [],
            payable: false,
            stateMutability: 'nonpayable',
            type: 'function',
        },
        {
            ...
            inputs: [
                ...
                { internalType: 'address', name: '_stakingThalesBonusRewardsManager', type: 'address' },
            ],
            name: 'setAddresses',
            outputs: [],
            payable: false,
        ...
        {
            constant: false,
            inputs: [{ internalType: 'uint256', name: '_lastPeriodTimestamp', type: 'uint256' }],
            name: 'setLastPeriodTimestamp',
            outputs: [],
            payable: false,
            stateMutability: 'nonpayable',
            type: 'function',
        ...
        },
        {
            ...
            inputs: [
                ...
                { internalType: 'bool', name: '_readOnlyMode', type: 'bool' },
                { internalType: 'bool', name: '_sendCCIPMessage', type: 'bool' },
            ],
        ...
        },
        {
            constant: true,
            inputs: [],
            name: 'stakingThalesBonusRewardsManager',
            outputs: [{ internalType: 'contract IStakingThalesBonusRewardsManager', name: '', type: 'address' }],
            payable: false,
            stateMutability: 'view',
            type: 'function',
        },
        ...
        },
        {
            constant: false,
            inputs: [
                { internalType: 'uint256', name: '_currentPeriodRewards', type: 'uint256' },
                { internalType: 'uint256', name: '_extraRewards', type: 'uint256' },
                { internalType: 'uint256', name: '_revShare', type: 'uint256' },
            ],
        ...
        },
        {
            ...
            name: 'updateVolumeAtAmountDecimals',
            outputs: [],
            payable: false,
            stateMutability: 'nonpayable',
            type: 'function',
...
export default stakingThalesContract;
